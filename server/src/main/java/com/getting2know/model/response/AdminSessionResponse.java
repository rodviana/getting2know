...
public class AdminSessionResponse {
    ...
    private final List<AdminSessionQuestionResponse> questions;

    public AdminSessionResponse(Long sessionId,
                                String code,
                                String status,
                                String format,
                                String hostUsername,
                                ...
                                List<AdminSessionQuestionResponse> questions) {
    ...
    public List<AdminSessionQuestionResponse> getQuestions() { return questions; }
}
